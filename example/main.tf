...
#In this example each app service will created under the respective App service plan
#For this example we are using linux os.
module "app_service" {
  source                    = "../"
  app_service_plan_count    = "2"
  app_service_plan_name     = ["azappserviceplan1","shubappsrvplan"]
  app_service_count         = "2"
  app_service_name          = ["hahahawebapp","mysrvwebapp"]
